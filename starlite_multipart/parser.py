...
class MultipartFormDataParser:
    ...
    def __init__(
        ...
        """
        _, options = parse_options_header(headers.get("Content-Type", ""))
        self.headers = headers
        self.stream = stream
        self.decoder = MultipartDecoder(message_boundary=options.get("boundary", ""), max_file_size=max_file_size)
